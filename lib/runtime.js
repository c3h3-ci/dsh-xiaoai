...
// ⚠️ extractAnswerText 也必须导入 —— #fetchRecords（多音箱版）用它从
//    对话记录的 answers[] 里挑出小爱真正说的话。曾经漏了这个导入，
//    导致每 2 秒一次的 "extractAnswerText is not defined" 轮询错误。
import { XiaomiSpeaker, extractAnswerText } from "./xiaomi.js";
